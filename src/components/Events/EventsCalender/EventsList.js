...
class TitlebarGridList extends Component {
  render() {
    ...
    var whatLeft = this.props.events.filter(function(el) {
      return (
        el.start.substring(6, 7) !== new Date().getMonth() + 1 &&
        el.start.substring(6, 7) !== new Date().getMonth() + 2
      );
    });
      ...
      <div className={classes.root}>
        <GridList cols={4} cellHeight={180} className={classes.gridList}>
            ...
            <GridListTile key={tile._id}>
              ...
              <GridListTileBar
                ...
                subtitle={
                  <span>
                    by:{" "}
                    {tile.creator.method == "google"
                      ? tile.creator.google.name
                      : tile.creator.method == "facebook"
                        ? tile.creator.facebook.name
                        : tile.creator.method == "local"
                          ? tile.creator.local.name
                          : null}
                  </span>
                }
                actionIcon={
          ...
          <GridListTile key="Subheader3" cols={4} style={{ height: "auto" }}>
            <ListSubheader component="div">
              Next month ({monthNames[new Date().getMonth() + 1]})
            </ListSubheader>
          </GridListTile>
